...
<header
    ...
    class="fixed top-0 left-0 w-full z-50 transition-all duration-500 ease-out
         {headerVisible || headerHovered || menuOpen
        ? 'translate-y-0'
        : '-translate-y-full'}
         {scrollY > 50
...
>
    <div class="max-w-6xl mx-auto px-4 flex items-center justify-between h-16">
        ...
        <a href="/about" class="relative group logo-container">
            <div
                class="absolute inset-y-0 left-0 w-64 bg-gradient-to-r from-black to-gray-800 dark:from-white dark:to-gray-200
            ...
            ></div>
            <h1
                class="relative z-10 pl-6 text-2xl font-bold text-white dark:text-black
            ...
            <div
                class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300
                  bg-gradient-to-r from-gray-500/20 to-gray-700/20 dark:from-gray-300/20 dark:to-gray-500/20 blur-xl -z-10"
            ></div>
        </a>
        ...
        >
            {#each navItems as { href, label }}
                <a
                 ...
                 {currentPath === href
                        ? 'nav-active bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100'
                        : ''}"
                ...
                >
                    ...
                    <!-- Hover glow -->
                    <div
                        class="absolute inset-0 opacity-0 border border-black dark:border-white group-hover:opacity-100 transition-opacity duration-300
                      bg-gradient-to-r from-gray-500/10 to-gray-700/10 dark:from-gray-300/10 dark:to-gray-500/10 rounded-lg -z-10"
                    ></div>
                </a>
            {/each}
        </nav>
        ...
        <div class="flex items-center space-x-3">
           ...
           bg-gray-100 dark:bg-gray-800"
                >
                    <span
                        class="w-6 h-6 text-black dark:text-white transition-transform duration-300 hover:rotate-180 inline-block"
                    >
                        {#if theme === "dark"}
            ...
            >
                <div class="w-6 h-6 flex flex-col justify-center space-y-1.5">
                    <span
                        class="block w-6 h-0.5 bg-black dark:bg-white transform transition-all duration-300 ease-out
                     {menuOpen
                            ? 'rotate-45 translate-y-2 bg-gray-700 dark:bg-gray-300'
                            : ''}"
                    ></span>
                    <span
                        class="block w-6 h-0.5 bg-black dark:bg-white transition-all duration-300 ease-out
                ...
                <div
                    class="absolute inset-0 opacity-0 hover:opacity-100 transition-opacity duration-300
                    bg-gradient-to-r from-gray-500/20 to-gray-700/20 dark:from-gray-300/20 dark:to-gray-500/20 rounded-full blur-md -z-10"
                ></div>
            </button>
        </div>
    </div>
    ...
    {#if menuOpen}
        ...
        >
            ...
            <div
                class="absolute inset-0 bg-white/80 dark:bg-black/80 backdrop-blur-xl"
            ></div>
            ...
            rounded-full blur-md -z-10"
                ...
                {#each navItems as { href, label }, index}
                   ...
                   {currentPath === href
                            ? 'bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-inner'
                            : ''}"
                        style="animation-delay: {index * 0.1}s"
                        aria-current={currentPath === href ? "page" : undefined}
                    >
                        <span
                            class="font-medium tracking-wide transition-all duration-300 group-hover:tracking-wider"
                        >
                            {label}
                        </span>
                        ...
                        <!-- Arrow indicator -->
                        <span
                            class="ml-auto opacity-0 group-hover:opacity-100 transition-all duration-300
                ...
                <div
                    class="py-3 px-6 text-center text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200/50 dark:border-gray-700/50"
                >
