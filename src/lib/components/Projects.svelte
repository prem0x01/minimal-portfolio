...
<section
    class="relative py-16 px-6 min-h-screen bg-white dark:bg-[#111111] dark:text-white transition-colors duration-300 overflow-hidden"
>
    <!-- Grid Lines Background -->
    <div
        class="absolute inset-0 grid grid-cols-12 gap-2 opacity-10 pointer-events-none z-0"
    >
                    ...
                    >
                        ...
                        <div class="flex flex-col justify-between p-6 flex-1">
                            <div>
                                ...
                                <p
                                    class="mb-4 text-gray-600 dark:text-gray-300 line-clamp-3"
                                >
                                    {project.description}
                                </p>
                            </div>
                            <div class="flex flex-wrap gap-2 mt-auto">
                                {#each project.tags as tag}
                                    <span
                                        class="bg-black/80 text-white text-sm px-3 py-1 rounded-full"
                                        >{tag}</span
                                    >
                                {/each}
                            </div>
