...
<section class="py-16 px-6 bg-white dark:bg-[#111111] mx-auto">
    ...
    <img
        src={project.image}
        alt={project.title}
        class="w-full h-auto mb-6 max-w-4xl rounded shadow-lg"
    />
    <p class="mb-4 text-lg text-gray-700 item-center dark:text-gray-300">
        {project.description}
    </p>
